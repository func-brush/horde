...
if CLIENT then
    ...
    killicon.Add( "arccw_horde_bo_m14", "arccw/weaponicons/arccw_horde_bo_hk21", Color( 0, 0, 0, 255 ) )
end
...
SWEP.Trivia_Desc = "Basic rifle with decent stopping power."
...
SWEP.ViewModel = "models/horde/weapons/bo/m14/viewmodel.mdl"
SWEP.WorldModel = "models/horde/weapons/bo/m14/worldmodel.mdl"
...
SWEP.ShootSound = {
    ")horde/weapons/bo_m14/m14_shot_00.wav",
    ")horde/weapons/bo_m14/m14_shot_01.wav",
    ")horde/weapons/bo_m14/m14_shot_02.wav",
    ")horde/weapons/bo_m14/m14_shot_03.wav",
    ")horde/weapons/bo_m14/m14_shot_04.wav"
}
SWEP.LowShootSound = ")horde/weapons/bo_m14/m14_lfe_00.wav"
...
SWEP.IronSightStruct = {
    Pos = Vector( -3.3944, -3.3483, 1.0714 ),
    Ang = Angle( -0.4948, 0.0518, 0 ),
    Magnification = 1.1,
}
...
SWEP.AttachmentElements = {
    ...
    ["silencer"] = {
        VMElements = {
            {
                Model = "models/horde/weapons/bo/m14/atts/attachment_silencer.mdl",
                Bone = "tag_weapon",
                Offset = {
                    pos = Vector( 0, 0, 0 ),
                    ang = Angle( 0, -90, 0 ),
    ...
    ["grip"] = {
        VMElements = {
            {
                Model = "models/horde/weapons/bo/m14/atts/attachment_grip.mdl",
                Bone = "tag_weapon",
                Offset = {
                    pos = Vector( 0, 0, 0 ),
                    ang = Angle( 0, -90, 0 ),
...
sound.Add( {
    name = "ArcCW_Horde_BO_M14.Reload",
    volume = 1.0,
    sound = {
...
sound.Add( {
    name = "ArcCW_Horde_BO_M14.Pickup",
    volume = 1.0,
    sound = {
...
sound.Add( {
    name = "ArcCW_Horde_BO_M14.Rattle",
    volume = 1.0,
    sound = {
